...
public class LoadTestAssembly : ITestAssembly, IXunitSerializable
{
	Assembly? assembly;
...
#pragma warning restore CS0618
	...
	public Assembly Assembly =>
		assembly ?? throw new InvalidOperationException($"Attempted to retrieve an uninitialized {nameof(LoadTestAssembly)}.{nameof(Assembly)}");
