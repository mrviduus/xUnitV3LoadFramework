...
public class LoadTestMethodRunner(
    ...
    : XunitTestMethodRunner(testMethod, @class, method, testCases, diagnosticMessageSink, messageBus, aggregator,
    ...
    private LoadSettings? CreateLoadSettings(object? loadTestSettings)
    {
        if (loadTestSettings != null)
        {
            ...
            var settingsAttribute =
                properties.First(x => x.GetValue(loadTestSettings) is LoadTestSettingsAttribute)
