...
public class Load_when_you_push_several_items_onto_the_stack : Specification
{
	...
	//	intended design of specifications.)
	//[Load]
	//	public void should_pop_last_item_first1() =>
	//	Assert.Equal(element3, stack.Pop());

	[Load(order: 1, concurrency: 2, duration: 10000, interval: 500)]
	public void should_pop_last_item_first() =>
		Console.WriteLine("test");

	[Load(order: 2, concurrency: 2, duration: 5000, interval: 500)]
	public void should_pop_last_item_second() =>
		Console.WriteLine("test");

	[Load(order: 2, concurrency: 2, duration: 5000, interval: 500)]
	public void should_pop_last_item_3() =>
		Console.WriteLine("test");
	...
	//[Load(Order = 3, Concurrency = 2, Duration = 2, Interval = 2)]
	//public void should_pop_first_item_last() =>
	//	Assert.Equal(element1, stack.Pop());
}
